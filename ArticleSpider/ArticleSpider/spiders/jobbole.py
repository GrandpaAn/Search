...
class JobboleSpider(scrapy.Spider):
	...
	def parse(self, response):
		...
		# praise_nums = response.xpath("//span[contains(@class, 'bookmark-btn')]/text()").extract()[0]
		...
		# create_date = response.xpath('//p[@class="entry-meta-hide-on-mobile"]/a/text()').extract()[0].strip().replace(" ·", "").strip()
